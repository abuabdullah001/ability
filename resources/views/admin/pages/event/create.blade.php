...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">Event POST</h5>
                </div><!-- /.col -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header bg-blue text-center"> ADD Event</div>
                        <div class="card-body">
                                ...
                                <div class="active tab-pane">
                                    <form class="form-horizontal" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="">Needed Donation amount</label>
                                                <input type="integer" name="donation_amount" value="" class="form-control">
                                            ...
                                            <div class="col-md-12 form-group">
                                               <button type="submit" class="btn btn-info"> <a href=""></a> Donate</button>
                                            </div>
                                            <div class="col-md-12 form-group">
